...
const mapDispatchToProps = (dispatch) => ({
    updateState: (state) => dispatch(productAction.updateState(state)),
    toggleNewProduct: (state) => dispatch(productAction.toggleNewProduct(state)),
    onUpdateStateProduct: (data) => dispatch(productAction.updateStateProduct(data)),
    onGetByUserId: (userId) => dispatch(productAction.getByUserId(userId)),
    onDeleteProduction: (data) => dispatch(productAction.delete(data)),
