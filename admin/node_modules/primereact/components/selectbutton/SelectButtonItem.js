...
var SelectButtonItem = exports.SelectButtonItem = function (_Component) {
    ...
    _createClass(SelectButtonItem, [{
        ...
        value: function onFocus(event) {
            _DomHandler2.default.addClass(this.el, 'p-focus');
        }
    }, {
        key: 'onBlur',
        value: function onBlur(event) {
            _DomHandler2.default.removeClass(this.el, 'p-focus');
        }
    }, {
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-button p-component p-button-text-only', {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { ref: function ref(el) {
                        ...
                        }, type: 'checkbox', defaultChecked: this.props.selected, onFocus: this.onFocus, onBlur: this.onBlur,
