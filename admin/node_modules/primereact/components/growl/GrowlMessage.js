...
var GrowlMessage = exports.GrowlMessage = function (_Component) {
    ...
    _createClass(GrowlMessage, [{
        ...
        value: function renderCloseIcon() {
            if (this.props.message.closable !== false) {
                return _react2.default.createElement(
                    'a',
                    { className: 'p-growl-icon-close pi pi-times', onClick: this.onClose },
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-growl-item-container p-highlight', {
            ...
            var iconClassName = (0, _classnames2.default)('p-growl-image pi', {
