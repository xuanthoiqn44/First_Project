...
var MegaMenu = exports.MegaMenu = function (_Component) {
    ...
    _createClass(MegaMenu, [{
        ...
        value: function renderSubmenuIcon(item) {
            if (item.items) {
                var className = (0, _classnames2.default)('p-submenu-icon pi pi-fw', { 'pi-caret-down': this.props.orientation === 'horizontal', 'pi-caret-right': this.props.orientation === 'vertical' });
        ...
        value: function renderSubmenuItem(item, index) {
            ...
            if (item.separator) {
                ...
                var iconClassName = (0, _classnames2.default)(item.icon, 'p-menuitem-icon');
        ...
        value: function renderSubmenu(submenu) {
            ...
            var className = (0, _classnames2.default)('p-megamenu-submenu-header', submenu.className, { 'p-disabled': submenu.disabled });
        ...
        value: function renderCategory(category, index) {
            ...
            var className = (0, _classnames2.default)('p-menuitem', { 'p-menuitem-active': category === this.state.activeItem, 'p-disabled': category.disabled }, category.className);
            var iconClassName = (0, _classnames2.default)(category.icon, 'p-menuitem-icon');
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: category.url || '#', className: 'p-menuitem-link', target: category.target, onClick: function onClick(event) {
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-megamenu p-component', { 'p-megamenu-horizontal': this.props.orientation === 'horizontal', 'p-megamenu-vertical': this.props.orientation === 'vertical' }, this.props.className);
