...
var SplitButtonItem = exports.SplitButtonItem = function (_Component) {
    ...
    _createClass(SplitButtonItem, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-menuitem-link', { 'p-disabled': this.props.menuitem.disabled });
            var icon = this.props.menuitem.icon ? _react2.default.createElement('span', { className: (0, _classnames2.default)('p-menuitem-icon', this.props.menuitem.icon) }) : null;
            ...
            return _react2.default.createElement(
                'li',
                { className: 'p-menuitem', role: 'menuitem' },
