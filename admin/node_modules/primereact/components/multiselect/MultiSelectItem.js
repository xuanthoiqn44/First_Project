...
var MultiSelectItem = exports.MultiSelectItem = function (_Component) {
    ...
    _createClass(MultiSelectItem, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-multiselect-item', { 'p-highlight': this.props.selected });
            var checkboxClassName = (0, _classnames2.default)('p-checkbox-box p-component', { 'p-highlight': this.props.selected });
            var checkboxIcon = (0, _classnames2.default)('p-checkbox-icon p-c', { 'pi pi-check': this.props.selected });
