...
var Inplace = exports.Inplace = function (_Component3) {
    ...
    _createClass(Inplace, [{
        ...
        value: function renderDisplay(content) {
            var className = (0, _classnames2.default)('p-inplace-display', { 'p-disabled': this.props.disabled });
        ...
        key: 'render',
        value: function render() {
            var className = (0, _classnames2.default)('p-inplace p-component', { 'p-inplace-closable': this.props.closable }, this.props.className);
