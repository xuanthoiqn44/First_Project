        ...
        value: function renderElement() {
            ...
            if (this.props.suggestions) {
                items = this.props.suggestions.map(function (suggestion, index) {
                    ...
                    return _react2.default.createElement(
                        'li',
                        { key: index + '_item', className: 'p-autocomplete-list-item', onClick: function onClick(e) {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(el) {
                    ...
                    }, className: 'p-autocomplete-panel p-input-overlay', style: { maxHeight: this.props.scrollHeight } },
