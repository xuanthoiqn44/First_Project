...
var TieredMenuSub = function (_Component) {
    ...
    _createClass(TieredMenuSub, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)({ 'p-submenu-list': !this.props.root });
...
var TieredMenu = exports.TieredMenu = function (_Component2) {
    ...
    _createClass(TieredMenu, [{
        ...
        value: function show(event) {
            ...
            setTimeout(function () {
                _DomHandler2.default.addClass(_this5.container, 'p-menu-overlay-visible');
                _DomHandler2.default.removeClass(_this5.container, 'p-menu-overlay-hidden');
            }, 1);
        ...
        value: function renderElement() {
            ...
            var className = (0, _classnames2.default)('p-tieredmenu p-component', { 'p-tieredmenu-dynamic p-menu-overlay': this.props.popup }, this.props.className);
