...
var SlideMenuSub = exports.SlideMenuSub = function (_Component) {
    ...
    _createClass(SlideMenuSub, [{
        ...
        value: function renderSubmenuIcon(item) {
            if (item.items) {
                return _react2.default.createElement('span', { className: 'p-submenu-icon pi pi-fw pi-caret-right' });
            } else {
                return null;
            }
        }
        ...
        value: function render() {
            var className = (0, _classnames2.default)({ 'p-slidemenu-rootlist': this.props.root, 'p-submenu-list': !this.props.root, 'p-active-submenu': this.props.parentActive });
            var style = {
...
var SlideMenu = exports.SlideMenu = function (_Component2) {
    ...
    _createClass(SlideMenu, [{
        ...
        value: function renderBackward() {
            ...
            var className = (0, _classnames2.default)('p-slidemenu-backward', { 'p-hidden': this.state.level === 0 });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'p-slidemenu-backward-icon pi pi-fw pi-caret-left' }),
                _react2.default.createElement(
                    'span',
                    null,
        ...
        value: function show(event) {
            ...
            setTimeout(function () {
                _DomHandler2.default.addClass(_this6.container, 'p-menu-overlay-visible');
                _DomHandler2.default.removeClass(_this6.container, 'p-menu-overlay-hidden');
            }, 1);
        ...
        value: function hide(event) {
            ...
            if (this.container) {
                _DomHandler2.default.addClass(this.container, 'p-menu-overlay-hidden');
                _DomHandler2.default.removeClass(this.container, 'p-menu-overlay-visible');

                setTimeout(function () {
                    if (_this7.container) {
                        _this7.container.style.display = 'none';
                        _DomHandler2.default.removeClass(_this7.container, 'p-menu-overlay-hidden');
                    }
                }, 150);
            }
        ...
        value: function renderElement() {
            ...
            var className = (0, _classnames2.default)('p-slidemenu p-component', { 'p-slidemenu-dynamic p-menu-overlay': this.props.popup });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'p-slidemenu-wrapper', style: { height: this.props.viewportHeight + 'px' } },
                    _react2.default.createElement(
                        'div',
                        { className: 'p-slidemenu-content', ref: function ref(el) {
