...
var BreadCrumb = exports.BreadCrumb = function (_Component) {
    ...
    _createClass(BreadCrumb, [{
        ...
        value: function renderHome() {
            ...
            if (this.props.home) {
                var className = (0, _classnames2.default)('p-breadcrumb-home', this.props.home.className, { 'p-disabled': this.props.home.disabled });
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'a',
                        { href: this.props.home.url || '#', className: 'p-menuitem-link', target: this.props.home.target, onClick: function onClick(event) {
        ...
        value: function renderSeparator() {
            return _react2.default.createElement('li', { className: 'p-breadcrumb-chevron pi pi-chevron-right' });
        }
    }, {
        key: 'renderMenuitem',
        value: function renderMenuitem(item, index) {
            ...
            var className = (0, _classnames2.default)(item.className, { 'p-disabled': item.disabled });
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-breadcrumb p-component', this.props.className);
