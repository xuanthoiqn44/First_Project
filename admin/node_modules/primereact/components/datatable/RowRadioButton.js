...
var RowRadioButton = exports.RowRadioButton = function (_Component) {
    ...
    _createClass(RowRadioButton, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-radiobutton-box p-component p-radiobutton-relative', { 'p-highlight': this.props.selected });
            var iconClassName = (0, _classnames2.default)('p-radiobutton-icon p-clickable', { 'pi pi-circle-on': this.props.selected });
