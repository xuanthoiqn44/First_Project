...
var RowCheckbox = exports.RowCheckbox = function (_Component) {
    ...
    _createClass(RowCheckbox, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-checkbox-box p-component', { 'p-highlight': this.props.selected });
            var iconClassName = (0, _classnames2.default)('p-checkbox-icon p-clickable', { 'pi pi-check': this.props.selected });
