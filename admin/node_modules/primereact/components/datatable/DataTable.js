    ...
    _createClass(DataTable, [{
        ...
        value: function onHeaderCheckboxClick(event) {
            ...
            if (!event.checked) {
                ...
                selection = [].concat(_toConsumableArray(visibleData));
            } else {
                selection = [];
            }
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-datatable p-component', { 'p-datatable-responsive': this.props.responsive,
