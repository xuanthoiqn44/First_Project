...
var Steps = exports.Steps = function (_Component) {
    ...
    _createClass(Steps, [{
        ...
        value: function renderItem(item, index) {
            ...
            var className = (0, _classnames2.default)('p-steps-item', item.className, {
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-steps p-component', this.props.className, { 'p-steps-readonly': this.props.readonly });
