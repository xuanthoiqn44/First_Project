    ...
    _createClass(FileUpload, [{
        ...
        value: function renderChooseButton() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'p-button-icon p-button-icon-left p-clickable pi pi-fw pi-plus' }),
        ...
        value: function renderFiles() {
            ...
            return _react2.default.createElement(
                ...
                this.state.files.map(function (file, index) {
                    ...
                    return _react2.default.createElement(
                        'div',
                        { className: 'p-fileupload-row', key: file.name + file.type + file.size },
                        preview,
                        fileName,
                        size,
                        removeButton
        ...
        value: function renderBasic() {
            ...
            var buttonClassName = (0, _classnames2.default)('p-button p-fileupload-choose p-component p-button-text-icon-left', { 'p-fileupload-choose-selected': this.hasFiles() });
            var iconClassName = (0, _classnames2.default)('p-button-icon-left pi', { 'pi-plus': !this.hasFiles() || this.props.auto, 'pi-upload': this.hasFiles() && !this.props.auto });
