...
export declare class DropDownBase extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     */
    private initialize;
    protected DropDownBaseupdateBlazorTemplates(item: boolean, group: boolean, noRecord: boolean, action: boolean, value?: boolean, header?: boolean, footer?: boolean): void;
